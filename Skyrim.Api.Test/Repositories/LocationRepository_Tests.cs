...
namespace Skyrim.Api.Test.Repositories
{
    ...
    public class SaveLocation : LocationRepository_Tests
    {
        ...
        public async void WithInvalidLocations_LogsExpectedError()
        {
        ...
        //    [Fact]
        //    public async void WithValidCreateLocationDto_MapsLocationAsCity() // not needed anymore Move to domain.
        //    {
        //        // Arrange
